    ...
    <v-simple-table fixed-header>
      <template v-slot:default>
        ...
        <tr v-for="item in hostgroups" :key="item.name">
          ...
          <td>
            <v-btn small outlined color="green" @click="$router.push(`/hostgroup/${item.id}/read`)">
              <v-icon>mdi-magnify</v-icon>
            </v-btn>
            <v-btn small outlined color="orange" @click="$router.push(`/hostgroup/${item.id}/update`)">
              <v-icon>mdi-lead-pencil</v-icon>
            </v-btn>
            <v-btn small outlined color="red" @click="$router.push(`/hostgroup/${item.id}/delete`)">
